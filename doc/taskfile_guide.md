...
| `task profile:heaptrack` | Analyse en détail les allocations de tas dynamiques (Heap tracking) pour éliminer tout débordement ou allocation dans les boucles de rendu. |
